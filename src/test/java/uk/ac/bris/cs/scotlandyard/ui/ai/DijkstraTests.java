...
public class DijkstraTests {
    ...
    public void TestDijkstra() {
        ...
        assertThat(new Dijkstra().findDistance(57, 58, sgs)).isEqualTo(1);
        assertThat(new Dijkstra().findDistance(100, 125, sgs)).isEqualTo(2);
        assertThat(new Dijkstra().findDistance(128, 175, sgs)).isEqualTo(3);
    }
